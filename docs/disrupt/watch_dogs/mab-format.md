...
| **Watch Dogs 2** | `0x46AF` | `0x20` | Same layout as WDL |
...
- [blender-io-disrupt parser](https://github.com/Open-Source-Modding/blender-io-disrupt/blob/main/modules/Watch_Dogs/import_mab_wd.py) — WD1 reference implementation (440 lines)
- [blender-io-disrupt WDL parser](https://github.com/Open-Source-Modding/blender-io-disrupt/blob/main/modules/Watch_Dogs_Legion/import_mab_wdl.py) — WDL/WD2 reference (146 lines, imports WD1 bitstream decoder)
