...
<FormatTable
  ...
  rows={[
    { Field: 'magic', Type: 'char[4]', Description: 'Always PIMG. Identifies the format.' },
    { Field: 'version', Type: 'u32', Description: 'Format version. Known: 1.' },
    { Field: 'reserved', Type: 'u32', Description: 'Always 0. Purpose unknown.' },
    { Field: 'n_buffers', Type: 'u32', Description: 'Number of vertex/index buffer pairs. Always 1 in observed files.' },
    { Field: 'vsize', Type: 'u32', Description: 'Byte length of vertex_data.' },
    { Field: 'vertex_data', Type: 'u8[vsize]', Description: 'Packed vertex data. Layout matches the XBG LOD0 vertex format (stride, format, drawcall offsets from the parent XBG).' },
    { Field: 'isize', Type: 'u32', Description: 'Byte length of index_data.' },
    { Field: 'index_data', Type: 'u16[isize/2]', Description: 'Triangle strip/fan indices. Same format as XBG index buffers.' },
  ]}
/>
