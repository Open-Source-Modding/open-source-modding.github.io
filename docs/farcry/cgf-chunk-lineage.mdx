...
<FormatTable
  columns={[
    { header: 'FC1 `.cgf` chunk' },
    { header: 'FC6 XBG chunk (4CC)' },
    { header: 'Role' },
  ]}
  rows={[
    { 'FC1 `.cgf` chunk': '`ChunkType_Mesh`', 'FC6 XBG chunk (4CC)': '`SULC` (CLUS)', Role: 'cluster / submesh geometry' },
    { 'FC1 `.cgf` chunk': '`ChunkType_Node`', 'FC6 XBG chunk (4CC)': '`EDON` (NODE)', Role: 'node hierarchy' },
    { 'FC1 `.cgf` chunk': '`ChunkType_Mtl`', 'FC6 XBG chunk (4CC)': '`LTMR` (material ref)', Role: 'material list' },
    { 'FC1 `.cgf` chunk': '`ChunkType_BoneNameList`', 'FC6 XBG chunk (4CC)': '`DNKS` (SKND)', Role: 'bone names / skin data' },
    { 'FC1 `.cgf` chunk': '`ChunkType_BoneAnim`', 'FC6 XBG chunk (4CC)': '`ITOM` (MOTI)', Role: 'animation' },
    { 'FC1 `.cgf` chunk': '`ChunkType_BoneMesh` / `MeshMorphTarget`', 'FC6 XBG chunk (4CC)': '`KSRP` / `DIKS` (SKID)', Role: 'skinning / morph' },
    { 'FC1 `.cgf` chunk': '`ChunkType_SourceInfo`', 'FC6 XBG chunk (4CC)': 'header `HSEMI`/`HSEMG`', Role: 'file metadata' },
  ]}
/>
