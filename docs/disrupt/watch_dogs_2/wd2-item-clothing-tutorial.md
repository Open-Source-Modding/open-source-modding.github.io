...
> **Cross-reference**: XeNTaX WD2 clothing hashes & categories → [XeNTaX Watch Dogs knowledge §8–9, §11](../watch_dogs/xentax-watchdogs-knowledge.md); Entity XML structure → [`../watch_dogs/entity-xml-structure.md`](../watch_dogs/entity-xml-structure.md)
